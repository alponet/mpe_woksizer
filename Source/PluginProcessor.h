...
/**
*/
class Mpe_woksizerAudioProcessor  : public AudioProcessor, private AudioProcessorValueTreeState::Listener
{
public:    
...
private:
    ...
    Synthesiser osc1;
    SynthVoice* osc1Voice;
    Synthesiser osc2;
    SynthVoice* osc2Voice;
    Synthesiser oscNoise;
    NoiseVoice* noiseVoice;
    
    AudioBuffer<float> audioAnalyseBuffer;
    AudioBuffer<float> audioOutBuffer;
    
    AudioBuffer<float> osc1Buffer;
    AudioBuffer<float> osc2Buffer;
